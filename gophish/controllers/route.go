...
import (
	...
	"github.com/kgretzky/evilginx2/gophish/controllers/api"
	log "github.com/kgretzky/evilginx2/gophish/logger"
	mid "github.com/kgretzky/evilginx2/gophish/middleware"
	"github.com/kgretzky/evilginx2/gophish/middleware/ratelimit"
	"github.com/kgretzky/evilginx2/gophish/models"
	"github.com/kgretzky/evilginx2/gophish/util"
	"github.com/kgretzky/evilginx2/gophish/worker"
...
func (as *AdminServer) handleInvalidLogin(w http.ResponseWriter, r *http.Request, message string) {
	...
	_, err := templates.ParseFS(gophish.TemplatesFS, "templates/login.html", "templates/flashes.html")
	if err != nil {
		log.Error(err)
	}
...
func getTemplate(w http.ResponseWriter, tmpl string) *template.Template {
	templates := template.New("template")
	_, err := templates.ParseFS(gophish.TemplatesFS, "templates/base.html", "templates/nav.html", "templates/"+tmpl+".html", "templates/flashes.html")
	if err != nil {
		log.Error(err)
	}
